  ...
  { 
    ...
    children: [
      { 
        ...
        children: [
          // Cấp 3
          { key: ROUTES.HR.BENEFITS.BUDGET, label: <Link to={ROUTES.HR.BENEFITS.BUDGET}>Chính sách lương theo đơn vị</Link> },
...
export default function AdminLayout() {
  ...
  return (
    <Layout className="min-h-screen">
      {/* HEADER */}
      <Header className="bg-white px-4 flex items-center justify-between border-b border-gray-200 h-14 w-full fixed z-10">
