...
import { Breadcrumb, Tabs, Input, Select, Button, Table, Space, Switch } from 'antd';
import { SearchOutlined, PlusOutlined, DownloadOutlined, DeleteOutlined, EyeOutlined } from '@ant-design/icons';
import { Link } from 'react-router-dom';

export default function Budget() {
  const dataSource = [
    { key: '1', stt: 1, code: '3P_KDT', name: '3P_Khoán doanh thu', unit: 'CTCP Cấp thoát nước Phú Thọ (LinhPTP)', status: true, date: '14/04/2026', user: 'quynhnt' },
    { key: '2', stt: 2, code: '3P_BDH', name: '3P_Ban điều hành', unit: 'CTCP Cấp thoát nước Phú Thọ (LinhPTP)', status: true, date: '15/09/2025', user: 'linhptp' },
    { key: '3', stt: 3, code: '3P_CBQL', name: '3P_Cán bộ quản lý', unit: 'CTCP Cấp thoát nước Phú Thọ (LinhPTP)', status: true, date: '15/09/2025', user: 'linhptp' },
    { key: '4', stt: 4, code: '3P_HQCV', name: '3P_Hiệu quả công việc', unit: 'CTCP Cấp thoát nước Phú Thọ (LinhPTP)', status: true, date: '15/09/2025', user: 'linhptp' },
    { key: '5', stt: 5, code: '3P_KCV', name: '3P_Khoán công việc', unit: 'CTCP Cấp thoát nước Phú Thọ (LinhPTP)', status: true, date: '15/09/2025', user: 'linhptp' },
  ];
  ...
  const columns = [
    ...
    { title: 'Trạng thái', dataIndex: 'status', key: 'status', render: (val: boolean) => <Switch defaultChecked={val} /> },
  ...
  const tabItems = [
      ...
      children: (
        <div>
          ...
          <div className="flex justify-between items-center mb-4 mt-8">
            ...
            <div className="flex gap-2">
              <Input placeholder="Tìm kiếm nhanh..." prefix={<SearchOutlined className="text-gray-400" />} />
    ...
    },
    {
      ...
      children: <div className="py-20 text-center text-gray-500 border border-dashed border-gray-300 rounded-md bg-gray-50">Nội dung tab Thành phần lương</div>
    }
  ];
